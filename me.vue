<template>
  <div>
    <div
      v-if="mentee"
      :class="`bg-nitMaroon-100/50 flex flex-col space-y-4 ${
        mentee.enable_edit_profile ? `` : `cursor-not-allowed`
      }`"
    >
      <div :class="`p-2 ${mentee.enable_edit_profile ? `` : `pointer-events-none`}`">
        <!-- BASIC STUDENT INFO -->
        <div
          class="flex flex-col items-center justify-center gap-4 mt-5 ml-2 mx-auto font-bold text-xl"
        >
        ...
        <form
          class="flex flex-col items-center gap-4 mt-5 max-w-3xl mx-auto"
          @submit="(e) => updateBasic(e)"
        >
          ...
          <MiscMessage
            :class="`${
              basicMessage.text ? `opacity-100` : `opacity-0`
          ...
          <button
            type="submit"
            :disabled="!mentee.enable_edit_profile"
        ...
        <h2 class="mt-4 text-2xl font-bold uppercase mx-auto text-center">
          Personal Info
        </h2>
        <form
          class="flex flex-col items-center gap-4 mt-5 max-w-3xl mx-auto"
          @submit="(e) => updatePersonal(e)"
        >
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-2 w-full">
            <div class="grid grid-cols-2 items-center max-w-xs">
            ...
            <div class="grid grid-cols-2 items-center max-w-xs">
              ...
              <input
                ...
                class="font-semibold p-2 w-48"
                :value="
                  new Date(mentee.personal_info.date_of_birth || 0)
                    .toISOString()
                    .split(`T`)[0]
                "
              />
            ...
            <div class="grid grid-cols-2 items-center max-w-xs">
              ...
              <select
                ...
                class="font-semibold p-2 w-48"
              >
                <option value="male" :selected="mentee.personal_info.gender === `male`">
                  Male
                </option>
                <option
                  value="female"
                  :selected="mentee.personal_info.gender === `female`"
                >
                  Female
                </option>
              </select>
          ...
          <MiscMessage
            :class="`${
              personalMessage.text ? `opacity-100` : `opacity-0`
            } transition duration-500 ease-in-out w-full lg:w-96`"
        ...
        >
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-2 w-full">
            ...
            <div class="grid grid-cols-2 items-center max-w-xs">
              ...
              <input
                type="text"
                name="student_f_whatsapp"
                id="student_f_whatsapp"
                class="font-semibold p-2 w-48"
            ...
            <div class="grid grid-cols-2 items-center max-w-xs">
              ...
              <input
                type="email"
                name="student_f_email_id"
                id="student_f_email_id"
                class="font-semibold p-2 w-48"
          ...
          <MiscMessage
            :class="`${
              fatherMessage.text ? `opacity-100` : `opacity-0`
            } transition duration-500 ease-in-out w-full lg:w-96`"
        ...
        >
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-2 w-full">
            ...
            <div class="grid grid-cols-2 items-center max-w-xs">
              ...
              <input
                type="text"
                name="student_m_whatsapp"
                id="student_m_whatsapp"
                class="font-semibold p-2 w-48"
            ...
            <div class="grid grid-cols-2 items-center max-w-xs">
              ...
              <input
                type="email"
                name="student_m_email_id"
                id="student_m_email_id"
                class="font-semibold p-2 w-48"
          ...
          <MiscMessage
            :class="`${
              motherMessage.text ? `opacity-100` : `opacity-0`
            } transition duration-500 ease-in-out w-full lg:w-96`"
        ...
        <h2 class="mt-4 text-2xl font-bold uppercase mx-auto text-center">
          Achievements / Special Info
        </h2>
        <form
          class="flex flex-col items-center gap-4 pt-8"
          @submit="(e) => updateSpecial(e)"
        >
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            >
              ...
              <textarea
                :name="field"
                :id="field"
                :value="mentee.achievements[field]"
          ...
          <MiscMessage
            :class="`${
              specialMessage.text ? `opacity-100` : `opacity-0`
            } transition duration-500 ease-in-out w-full lg:w-96`"
    ...
    <!-- new button added -->
    <button type="button" @click="downloadPDF" :disabled="!mentee.enable_edit_profile">
      Download PDF
    </button>
  </div>
...
const downloadPDF = () => {
  ...
  const formFields = [
    ...
    { label: 'Batch', value: mentee.batch },
    { label: 'Year', value: mentee.year },
    { label: 'section', value: mentee.section  },
    { label: 'Blood Group', value:mentee.personal_info.blood_group  }
    { label: 'Mobile number', value: mentee.personal_info.mobile_number  },
    { label: 'whatsapp number', value: mentee.personal_info.whatsapp_number  },
    { label: 'email id', value: mentee.personal_info.email_id },
  ];


  let yOffset = 10;
  formFields.forEach((field) => {
    pdf.text(`${field.label}: ${field.value}`, 10, yOffset);
    yOffset += 10; 
  });
